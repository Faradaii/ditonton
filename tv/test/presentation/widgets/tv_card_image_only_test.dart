...
import 'tv_card_image_only_test.mocks.dart';
...
void main() {
  ...
  testWidgets('should display poster', (WidgetTester tester) async {
    // Arrange
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
          body: TvCardImageOnly(tv: tTvSeries),
        ),
      ),
    );
  ...
  testWidgets('should navigate to tvDetailPage on tap',
    ...
    // Assert
    verify(mockObserver.didPush(any, any)).called(1);
    expect(find.text('tv ID: 1'), findsOneWidget);
  });
}
